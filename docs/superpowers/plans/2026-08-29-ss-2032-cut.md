...
- [ ] **Step 3: Add the params to `MonteCarloParams`**
...
- [ ] **Step 5: Kernel — survivor swap becomes SS-aware**
...
- [ ] **Step 1: Append failing tests to `src/__tests__/simulate.test.ts`**
...
- [ ] **Step 3: Schema + translation in `src/routes/simulate.ts`**
...
- [ ] **Step 4: Field label in `src/lib/validation.ts`**
...
- [ ] **Step 1: Add term** (adapt key/shape to the file's existing structure):
...
- [ ] **Step 2: Run glossary tests / typecheck**
