...
import { runMonteCarlo, mulberry32, type MonteCarloParams, type LocationMove } from '../../engine/monte-carlo.js';
 ...
 *
 * Ported from retirement-dashboard-angular/src/app/lib/monte-carlo-segment-magi.spec.ts
 * as part of B2 (Monte Carlo engine consolidation into @retirement/shared).
 */
