...
export const ACA_PCT_SOURCES_2026 = [
    {
 ...
 */
export function applicablePctCliff2026(fplPct) {
    if (fplPct < 100)
        return null;
    let prevUpper = 100;
    for (const b of ACA_BRACKETS_2026) {
        if (fplPct < b.fplPctUpper) {
            if (b.startPct === b.endPct)
                return b.startPct;
