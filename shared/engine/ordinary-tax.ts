...
export const FED_ADDL_STD_DEDUCTION_65_2026 = { mfj: 1650, single: 2050 } as const;
...
function bracketTax(taxable: number, filingStatus: OrdinaryFilingStatus, indexFactor: number): number {
...
export function ordinaryFederalTax(inp: OrdinaryTaxInputs): number {
 ...
 * `extra` returns 0.
 */
export function ordinaryTaxDelta(inp: OrdinaryTaxInputs, extra: number): number {
  if (!(extra > 0)) return 0;
