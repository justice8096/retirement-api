 ...
 */
export const FED_BRACKETS_2026_MFJ = [
...
export const FED_BRACKETS_2026_SINGLE = [
 ...
 */
export const FED_BRACKETS_2026_SOURCES = [
    {
...
export const FED_STD_DEDUCTION_2026_SOURCES = [
    {
...
export const OBBBA_SENIOR_SOURCES = [
    {
...
export const LTCG_BRACKETS_2026_SOURCES = [
    {
 ...
 */
export function ltcgZeroBracketHeadroom(ordinaryTaxableIncome, filingStatus, alreadyPreferential = 0) {
 ...
 */
export function ltcgHarvestingSummary(ordinaryTaxableIncome, filingStatus, alreadyPreferential = 0) {
    const brackets = LTCG_BRACKETS_2026[filingStatus];
    const O = Math.max(0, ordinaryTaxableIncome);
    const P = Math.max(0, alreadyPreferential);
    const stackBase = O + P;
    ...
    let currentMarginalRate;
    if (stackBase < brackets.zeroTop)
        currentMarginalRate = 0;
    else if (stackBase < brackets.fifteenTop)
        currentMarginalRate = 0.15;
    else
        currentMarginalRate = 0.20;
    return {
        filingStatus,
...
export const RENTAL_DEPRECIATION_SOURCES = [
    {
...
export const RENTAL_SCHEDULE_E_SOURCES = [
    {
